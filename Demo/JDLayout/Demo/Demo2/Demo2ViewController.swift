...
public class Demo2ViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        self.view0.jd_size(CGSize(width: 200, height: 100)).jd_centerX(self.view).jd_centerY(self.view).jd_layout()
        ...
        self.view1.jd_frame(CGRect(x: 100, y: 100, width: 10, height: 10)).jd_width(self.view0).jd_height(self.view0).jd_layout()
    }
